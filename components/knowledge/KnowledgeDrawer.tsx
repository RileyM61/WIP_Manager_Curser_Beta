...
export const KnowledgeDrawer: React.FC<KnowledgeDrawerProps> = ({ isOpen, onClose, initialDocId }) => {
  ...
  return (
    <Transition show={isOpen} as="div" className="fixed inset-0 z-50">
      ...
      <Transition.Child
        as="div"
        className="absolute right-0 top-0 h-full w-full max-w-3xl bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-700 shadow-2xl flex flex-col"
