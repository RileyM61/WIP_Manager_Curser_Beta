...
const CFOChatDrawer: React.FC<CFOChatDrawerProps> = ({
  ...
  return (
    <Transition show={isOpen} as="div" className="fixed inset-0 z-50">
      ...
      <Transition.Child
        as="div"
        className="absolute right-0 top-0 h-full w-full max-w-lg bg-gray-50 dark:bg-gray-900 border-l border-gray-200 dark:border-gray-700 shadow-2xl flex flex-col"
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="bg-amber-50 dark:bg-amber-900/30 rounded-2xl rounded-tl-md px-4 py-3">
                      <div className="flex items-center gap-1">
                        <span className="w-2 h-2 bg-wip-gold rounded-full animate-bounce" style={{ animationDelay: '0ms' }}></span>
                        <span className="w-2 h-2 bg-wip-gold rounded-full animate-bounce" style={{ animationDelay: '150ms' }}></span>
                        <span className="w-2 h-2 bg-wip-gold rounded-full animate-bounce" style={{ animationDelay: '300ms' }}></span>
                      </div>
                    </div>
                  </div>
                )}
