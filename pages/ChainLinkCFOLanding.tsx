  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500/20 to-amber-500/20 flex items-center justify-center text-2xl group-hover:scale-110 transition-transform">
          {module.icon}
        </div>
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            {module.comingSoon && (
              <span className="text-[10px] uppercase tracking-wide bg-slate-700 text-slate-300 px-2 py-0.5 rounded-full">
                Coming Soon
              </span>
            )}
          </div>
...
const StatCard: React.FC<{
  ...
  >
    <div className="text-4xl sm:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-400 mb-2">
      {value}
    </div>
    ...
    <div className="bg-slate-950 text-white overflow-hidden">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-6 py-20 sm:px-8 md:px-10">
          ...
          <div className="text-center mt-24 lg:mt-16">
            ...
            >
              ...
              <span className="text-sm text-orange-300 font-medium">The Complete Financial Toolkit for Contractors</span>
            </div>
            ...
            {/* Stats */}
            <div
              className="grid grid-cols-2 sm:grid-cols-4 gap-8 max-w-4xl mx-auto pt-8 border-t border-white/10"
      ...
      <section id="modules" className="py-24">
        <div className="mx-auto max-w-6xl px-6 sm:px-8 md:px-10">
          ...
          <div className="text-center mt-12">
            <button
              onClick={handleGetStarted}
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-orange-500 to-amber-500 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-orange-500/30 transition-all"
            >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.step} className="relative">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center text-2xl font-bold text-white mb-6 shadow-lg shadow-orange-500/30">
                  {item.step}
                </div>
                <h3 className="text-xl font-semibold text-white mb-3">{item.title}</h3>
                <p className="text-slate-400">{item.description}</p>
      ...
      <section className="py-16 bg-gradient-to-r from-orange-500/10 to-amber-500/10 border-y border-orange-500/20">
        <div className="mx-auto max-w-4xl px-6 sm:px-8 md:px-10 text-center">
          ...
          <a
            href="/wip"
            className="inline-flex items-center gap-2 px-6 py-3 border-2 border-orange-500 text-orange-400 font-semibold rounded-xl hover:bg-orange-500 hover:text-white transition-all"
          >
