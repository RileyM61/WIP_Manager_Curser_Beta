        ...
        <div className="min-h-screen bg-slate-950 text-white">
            ...
            <main className="container mx-auto px-4 py-12 max-w-4xl">
                ...
                <div className="prose prose-invert prose-lg max-w-none space-y-8">
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                                ...
                                <p className="text-white/60 text-sm mb-3">Required for the Service to function properly. Cannot be disabled.</p>
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                                ...
                                <p className="text-white/60 text-sm mb-3">Remember your preferences and settings.</p>
                                <ul className="text-white/60 text-sm space-y-1">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                                ...
                                <p className="text-white/60 text-sm mb-3">Help us understand how visitors interact with the Service.</p>
                                <ul className="text-white/60 text-sm space-y-1">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-orange-400 mb-4">3. Local Storage</h2>
                        <p className="text-white/80 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-orange-400 mb-4">4. Third-Party Cookies</h2>
                        ...
                        <div className="bg-white/5 rounded-xl p-6 border border-white/10 space-y-4">
                            <div>
                                ...
                                <p className="text-white/60 text-sm">Authentication and session management</p>
                            </div>
                            <div>
                                <h3 className="font-semibold text-white">Stripe</h3>
                                <p className="text-white/60 text-sm">Payment processing (fraud prevention)</p>
                            </div>
                        </div>
                    </section>

                    <section>
                        <h2 className="text-2xl font-semibold text-orange-400 mb-4">5. Managing Cookies</h2>
                        <p className="text-white/80 leading-relaxed mb-4">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-orange-400 mb-4">6. Changes to This Policy</h2>
                        <p className="text-white/80 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-orange-400 mb-4">7. Contact Us</h2>
                        <p className="text-white/80 leading-relaxed">
